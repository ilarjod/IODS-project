...
Survey is about students' studying and free time from two different classes. Data has no identifier for the students but it includes many background variables that can be used to combine the data.
...
```
Living area and family size seem to have something to do with with high alcohol consumption along with high correlation with going out more.
